...
const SearchPage=({items,match,searchField})=>{
    ...
    console.log('pram',searchFieldParams)
    console.log('bruh')
    ...
    if(currentPage === 'movies' && searchFieldParams.length > 0){
        searchItems = arr.filter(item=>
            item.title.toLowerCase().includes(searchFieldParams.toLowerCase()) 
         || item.performer.toLowerCase().includes(searchFieldParams.toLowerCase())
    ...
    if(currentPage === 'books' && searchFieldParams.length > 0){
        searchItems = arr.filter(item=>
         ...
         || item.publisher.toLowerCase().includes(searchFieldParams.toLowerCase())
         || item.title.toLowerCase().includes(searchFieldParams.toLowerCase())
          )
    }
