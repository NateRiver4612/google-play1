import React, { lazy, useRef, Suspense, useEffect, useState } from "react";
...
const MovieCollectionContainer = lazy(() =>
  import("./MovieCollection.container")
);
...
const Movie = ({ match, cartCategories, history }) => {
      ...
      <ErrorBoundary>
        ...
        <Suspense fallback={<Spinner />}>
          ...
          <Route
            ...
            component={MovieCollectionContainer}
          />
          <Route
            path={`${match.path}/details/:movieInfo`}
            component={MovieDetailContainer}
          />
          <Route
            path={`${match.path}/participant/:personInfo`}
            component={PersonPage}
          />
          <Route exact path={`${match.path}/:chartId`} component={ChartPage} />
          <Route
            path={`${match.path}/search/:searchInfo`}
