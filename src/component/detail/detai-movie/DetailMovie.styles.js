...
export const BuyButton = styled(StripeCheckoutButton)`
...
`;
export const AddCartButton = styled.div.attrs((props) => ({
...
export const WarningIcon = styled(BsFillExclamationCircleFill)`
  font-size: 12px;
  color: #b04131;
