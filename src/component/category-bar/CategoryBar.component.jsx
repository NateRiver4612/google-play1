...
const CategoryBar=({history,toggleCartHidden,empty,currentCart,homeLink})=> {
    ...
    return (
        <Container >
            ...
            <Wrap className="HomePage"  style={{borderBottom:` ${currentOption.length < 3 ? '3px' :'0px'} ${currentOption.length < 3 ? currentColor : 'white'} solid`}}>
            ...
            <Link to={`${homeLink}/top`} style={{visibility:`${empty ? 'hidden' : ''}`}} >
            <Wrap className="Charts" style={{borderBottom:` ${currentOption.includes('top') ? '3px' :'0px'}   ${currentOption.includes('top') ? currentColor : 'white'} solid`}}>
                Charts
            </Wrap>
            </Link>

            <Link to={`${homeLink}/new`} style={{visibility:`${empty ? 'hidden' : ''}`}} >
            <Wrap className="New" style={{borderBottom:` ${currentOption.includes('new') ? '3px': '0px'}  ${currentOption.includes('new')  ? currentColor : 'white'} solid`}}>
                New release
            </Wrap>
            </Link>
        </Container>
